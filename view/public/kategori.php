...
if(isset($_GET['slug'])){
    $slug = $_GET['slug'];
    $category = mysqli_query($conn, "SELECT * FROM category WHERE slug='$slug' LIMIT 1");
    $category = mysqli_fetch_assoc($category);
    $article = mysqli_query($conn, "SELECT * FROM articles WHERE category_id='$category[id]'");
    ...
    <div class="container">
        ...
        <div class="row w-100">
            ...
            <div class="col-lg-6 col-md-9 col-12 order-lg-2 order-md-2 order-1">
                <p class="fs-5 fw-bold">Menampilkan Kategori <?php echo $category['name'];?> :</p>
                <article>
                    <?php
